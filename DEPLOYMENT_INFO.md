...
| **PROD** | Customer distribution | Customers | `browser-extension/dist/grrab-prod.zip` |
...
cd browser-extension
npm run build:prod
# Output: browser-extension/dist/grrab-prod.zip
```
...
- **2026-04-21 (evening)** — Taxonomy overhaul + YouTube thumbnail feature + data migration.
  ...
  - **PROD release:**
    - New `dist/grrab-prod.zip` rebuilt (324.98 KB, 23 files).
