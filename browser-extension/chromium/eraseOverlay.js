...
export function showEraseOverlay(blob, inpaintFn, commitFn, bindStatus, bgFn) {
  ...
  const p = new Promise((resolve) => {
    ...
    stage.style.cssText = [
      ...
      'background-image: linear-gradient(45deg, #d8d8d8 25%, transparent 25%, transparent 75%, #d8d8d8 75%), linear-gradient(45deg, #d8d8d8 25%, transparent 25%, transparent 75%, #d8d8d8 75%)',
  ...
  `;
    ...
    function updateUi() {
      ...
      stage.style.backgroundImage = stageCheckerBgImage;
